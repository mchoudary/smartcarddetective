...
/* Enable C linkage for C++ Compilers: */
	...
	/* Public Interface - May be used in end-application: */
		/* Macros: */
			...
			#define LEDS_LED1 0x41       // TODO: Add mask for first board LED here

			/** LED mask for the second LED on the board. */
			#define LEDS_LED2 0x42       // TODO: Add mask for second board LED here

			/** LED mask for the third LED on the board. */
			#define LEDS_LED3 0x44       // TODO: Add mask for third board LED here

			/** LED mask for the fourth LED on the board. */
			#define LEDS_LED4 0x48       // TODO: Add mask for fourth board LED here
		...
		/* Inline Functions: */
			...
			static inline uint8_t LEDs_GetLEDs(void)
			{
                ...
                uint8_t result = 0x40;
                if(bit_is_set(PINE, PB7)) result = result | 1;
                if(bit_is_set(PINE, PB6)) result = result | 2;
                if(bit_is_set(PINE, PB5)) result = result | 4;
                if(bit_is_set(PINE, PB4)) result = result | 8;
			...
			static inline void LEDs_ToggleLEDs(const uint8_t LEDMask)
			{
                ...
                LEDs_TurnOnLEDs(LEDMask ^ LEDs_GetLEDs());
			}
		#endif
